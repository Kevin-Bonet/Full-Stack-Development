...
function returnReviews(url) {
  fetch(url + "movie/" + movieId)
      ...
      .then(function (data) {
          ...
          reviewsContainer.innerHTML = ''; // Only clear reviews, not the entire main content
          ...
          data.forEach(review => {
              ...
              `;
              reviewsContainer.appendChild(div_card);
          });
      })
...
function editReview(id, review, user) {
  ...
  function saveReview(reviewInputId, userInputId, id = "") {
    ...
    if (id) {
        ...
        // Ensure URL for creating a new review is correct
        fetch(APILINK + "new", {
            method: 'POST',
            headers: {
                'Accept': 'application/json, text/plain, */*',
